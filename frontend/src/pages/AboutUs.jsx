...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 px-6 relative font-sans">
      {/* Background elements */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-green-50 blur-[120px] rounded-full pointer-events-none -z-10"></div>
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-amber-50 blur-[120px] rounded-full pointer-events-none -z-10"></div>
      ...
      <div className="max-w-6xl mx-auto space-y-24">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div 
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl text-gray-900 font-bold tracking-tight">Our Story</h2>
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-white rounded-3xl border border-slate-200 shadow-soft p-8 bg-white/50 relative overflow-hidden"
          >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-6 py-8">
              ...
              <h3 className="text-2xl text-gray-900 font-bold tracking-tight">Share Food, Spread Hope.</h3>
              <p className="text-gray-600 leading-relaxed">Join thousands of others in the movement against food waste.</p>
            </div>
          </motion.div>
        </section>
        ...
        <section className="space-y-12">
          <div className="text-center">
            <h2 className="text-3xl mb-4 text-gray-900 font-bold tracking-tight">Our Core Values</h2>
            <p className="max-w-2xl mx-auto text-gray-600 leading-relaxed">The principles that guide our platform, our team, and our wonderful community.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <motion.div 
                ...
                className="bg-white rounded-2xl border border-slate-200 shadow-soft p-6 bg-white/50 hover:border-green-500/30 transition-all hover:-translate-y-1"
              >
                <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mb-6">
                  {v.icon}
                </div>
                <h3 className="text-xl mb-3 text-gray-900 font-bold tracking-tight">{v.title}</h3>
