  ...
  return (
    <div className="flex flex-col h-[calc(100vh-80px)]">
      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          <h2 className="text-2xl mb-1 text-gray-900 font-bold tracking-tight">Live Map</h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium text-gray-700 hover:text-white border border-gray-200 hover:border-green-500/50 rounded-lg transition-colors"
          >
            Refresh
          </button>
        </div>
      ...
      {/* Map Container */}
      <div className="flex-1 bg-gray-50 rounded-xl overflow-hidden border border-gray-200 shadow-2xl relative">
        <MapView
          center={center}
        ...
        <div className="absolute top-4 left-4 z-[400] flex gap-2">
          <div className="bg-gray-50 backdrop-blur-md px-3 py-1.5 rounded-lg border border-gray-200 text-xs text-gray-700">
        ...
        {/* Legend */}
        <div className="absolute bottom-6 right-6 z-[400] bg-gray-50 backdrop-blur-md p-4 rounded-xl border border-gray-200 shadow-xl">
          <h4 className="text-sm mb-3 text-gray-900 font-bold tracking-tight">Legend</h4>
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-700">Donor (Available Food)</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-orange-500"></span>
              <span className="text-sm text-gray-700">Volunteer (Active)</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-red-500"></span>
              <span className="text-sm text-gray-700">NGO Request (Food Needed)</span>
            </div>
          </div>
        </div>
      </div>
