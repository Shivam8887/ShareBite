          ...
          {sent ? (
            <>
              ...
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold text-dark-100 mb-3">Check your email</h2>
                ...
                <Link
                  to="/login"
                  className="inline-block px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white font-semibold rounded-xl shadow-lg shadow-primary-500/20 transition-all"
                >
                  Back to Login
                </Link>
              </div>
            ...
            <>
              <h2 className="text-xl font-semibold text-dark-100 mb-2">Forgot your password?</h2>
