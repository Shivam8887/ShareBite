      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        >
          ...
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 font-bold tracking-tight">1. What are cookies?</h2>
            <p>
          ...
          {/* Section 2 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 font-bold tracking-tight">2. How we use cookies</h2>
            ...
            <ul className="space-y-4 list-none pl-0">
              <li className="bg-white p-4 rounded-xl border border-gray-200">
                <h3 className="font-medium mb-1 text-gray-900 font-bold tracking-tight">Essential Cookies</h3>
                <p className="text-sm text-gray-700 leading-relaxed">Required for the platform to function properly. These include cookies that enable you to log into secure areas like your User Dashboard.</p>
              </li>
              <li className="bg-white p-4 rounded-xl border border-gray-200">
                <h3 className="font-medium mb-1 text-gray-900 font-bold tracking-tight">Analytical/Performance Cookies</h3>
                <p className="text-sm text-gray-700 leading-relaxed">These allow us to recognize and count the number of visitors and see how visitors move around our platform when using it. This helps us improve the way ShareBite works.</p>
              </li>
              <li className="bg-white p-4 rounded-xl border border-gray-200">
                <h3 className="font-medium mb-1 text-gray-900 font-bold tracking-tight">Functionality Cookies</h3>
                <p className="text-sm text-gray-700 leading-relaxed">Used to recognize you when you return to our platform. This enables us to personalize our content for you and remember your preferences.</p>
              </li>
            </ul>
          </section>
          ...
          {/* Section 3 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 font-bold tracking-tight">3. Third-party cookies</h2>
            <p>
          ...
          {/* Section 4 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 font-bold tracking-tight">4. Managing your cookie preferences</h2>
            <p>
