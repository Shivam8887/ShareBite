      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        >
          ...
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 dark:text-dark-50 font-bold tracking-tight">1. Acceptance of Terms</h2>
            <p>
          ...
          {/* Section 2 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 dark:text-dark-50 font-bold tracking-tight">2. Use License</h2>
            <p>
            ...
            <ul className="space-y-2 list-none pl-0 bg-white dark:bg-dark-800/50 p-6 rounded-2xl border border-gray-200 dark:border-dark-700">
          ...
          {/* Section 3 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 dark:text-dark-50 font-bold tracking-tight">3. Disclaimer</h2>
            <p>
          ...
          {/* Section 4 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 dark:text-dark-50 font-bold tracking-tight">4. User Responsibilities</h2>
          ...
          {/* Section 5 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 dark:text-dark-50 font-bold tracking-tight">5. Termination</h2>
            <p>
          ...
          {/* Section 6 */}
          <section className="space-y-4">
            <h2 className="text-2xl text-gray-900 dark:text-dark-50 font-bold tracking-tight">6. Modifications</h2>
            <p>
